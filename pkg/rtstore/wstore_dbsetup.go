...
import (
	...
	"github.com/LannCo/remoteterm/pkg/util/migrateutil"
	"github.com/jmoiron/sqlx"
	"github.com/sawka/txwrap"

	dbfs "github.com/LannCo/remoteterm/db"
)
...
func GetDBName() string {
	waveHome := remotetermbase.GetWaveDataDir()
	return filepath.Join(waveHome, remotetermbase.WaveDBDir, WStoreDBName)
}
...
func WithTx(ctx context.Context, fn func(tx *TxWrap) error) (rtnErr error) {
	remotetermobj.ContextUpdatesBeginTx(ctx)
	defer func() {
		if rtnErr != nil {
			remotetermobj.ContextUpdatesRollbackTx(ctx)
		} else {
			remotetermobj.ContextUpdatesCommitTx(ctx)
		}
	}()
