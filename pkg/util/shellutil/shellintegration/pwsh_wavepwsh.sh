...
$waveterm_swaptoken_output = wsh token $env:REMOTETERM_SWAPTOKEN pwsh 2>$null | Out-String
...
Remove-Item Env:REMOTETERM_SWAPTOKEN
...
$Global:_REMOTETERM_SI_FIRSTPROMPT = $true
