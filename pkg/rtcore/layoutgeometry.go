...
func ComputeBlockGeometry(ctx context.Context, tabId string) (*BlockLayoutInfo, error) {
	...
	layoutState, err := rtstore.DBGet[*remotetermobj.LayoutState](ctx, tabObj.LayoutState)
	if err != nil {
	...
	var leafOrder []remotetermobj.LeafOrderEntry
...
func computeBlockLayoutInfo(info *BlockLayoutInfo, rootNode any, leafOrder []remotetermobj.LeafOrderEntry, focusedNodeId, magnifiedNodeId string) {
