...
RemoteTerm is a modern terminal that includes graphical capabilities like web browsing and file previews alongside traditional terminal features. This guide will help you get started.
...
- Report issues on [GitHub](https://github.com/LannCo/remoteterm/issues)
