...
| app:confirmquit <VersionBadge version="v0.14" />                     | bool     | Set to false to disable the quit confirmation dialog when closing RemoteTerm (defaults to true, requires app restart)                                                                                                                                      |
...
```json
{
    ...
    "web:defaulturl": "https://remoteterm.dev",
...
```json
{
  ...
  "bookmark@remoteterm": {
    "url": "https://remoteterm.dev",
    "title": "RemoteTerm",
    "display:order": -1
  },
  "bookmark@remoteterm-github": {
    "url": "https://github.com/LannCo/remoteterm",
    "title": "RemoteTerm GitHub",
  ...
  "bookmark@remoteterm-pulls": {
    "url": "https://github.com/LannCo/remoteterm/pulls",
    "title": "RemoteTerm Pull Requests",
    "iconurl": "https://github.githubassets.com/favicons/favicon-dark.png"
  }
}
```
...
Here is an example of defining a full terminal theme. All of the built-in themes are defined here: https://github.com/LannCo/remoteterm/blob/main/pkg/wconfig/defaultconfig/termthemes.json (if you'd like to add a popular terminal theme, please submit a PR!)
