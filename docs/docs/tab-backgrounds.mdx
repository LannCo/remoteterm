...
To see how RemoteTerm's built-in backgrounds are defined, check out the [default backgrounds.json file](https://github.com/LannCo/remoteterm/blob/main/pkg/wconfig/defaultconfig/backgrounds.json).
