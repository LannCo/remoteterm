...
# Welcome to RemoteTerm

RemoteTerm is an [open-source](https://github.com/LannCo/remoteterm) terminal that combines traditional terminal features with graphical capabilities like file previews and web browsing. It runs on MacOS, Linux, and Windows.
...
If you have a question, please feel free to ask us in [Discord](https://discord.gg/XfvZ334gwU). If you'd like to file a bug/enchancement, please use [Github Issues](https://github.com/LannCo/remoteterm/issues). These docs are also open-source and we do accept PRs for docs [here](https://github.com/LannCo/remoteterm/blob/main/docs). You can click the "Edit this page" link at the bottom of the page to get taken directly to the editor page for that document in GitHub.
...
Want to provide input to our future releases? Connect with us on [Discord](https://discord.gg/XfvZ334gwU) or open a [Feature Request](https://github.com/LannCo/remoteterm/issues/new/choose)!
...
- **GitHub** https://github.com/LannCo/remoteterm/
