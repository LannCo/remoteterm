---
name: create-view
description: Guide for implementing a new view type in RemoteTerm. Use when creating a new view component, implementing the ViewModel interface, registering a new view type in BlockRegistry, or adding a new content type to display within blocks.
---
