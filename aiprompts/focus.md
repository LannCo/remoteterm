# RemoteTerm Focus System

This document explains how the focus system works in RemoteTerm, particularly for terminal blocks.

## Overview

RemoteTerm uses a multi-layered focus system that coordinates between:
