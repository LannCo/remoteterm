# Contributing to RemoteTerm

RemoteTerm is an opinionated project with a single active maintainer. Contributions are welcome, but **alignment matters more than volume**.
...
- RemoteTerm has a strong product direction and centralized ownership.
...
- RemoteTerm is not designed as a "first open source contribution" project
...
To build and run RemoteTerm locally, see instructions at [Building RemoteTerm](./BUILD.md).
...
Thank you for your interest in RemoteTerm. Clear expectations help keep the project moving quickly and sustainably.
