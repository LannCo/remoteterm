...
vi.mock("@/app/view/waveconfig/waveconfig", () => ({ WaveConfigView: {} }));
vi.mock("@/app/view/waveconfig/widgetscontent", () => ({ WidgetsContent: {} }));
vi.mock("@/app/view/waveconfig/backgroundscontent", () => ({ BackgroundsContent: {} }));
vi.mock("@/app/view/waveconfig/connectionscontent", () => ({ ConnectionsContent: {} }));
vi.mock("@/app/view/waveconfig/generalcontent", () => ({ GeneralContent: {} }));
vi.mock("@/app/view/waveconfig/secretscontent", () => ({ SecretsContent: {} }));
...
describe("WaveConfigViewModel — sidebar widgets (reorder / toggle / persist)", () => {
    let model: any;
    ...
    beforeEach(async () => {
        ...
        const { WaveConfigViewModel } = await import("./waveconfig-model");
        ...
        model = new (WaveConfigViewModel as any)({
            blockId: "test-block",
