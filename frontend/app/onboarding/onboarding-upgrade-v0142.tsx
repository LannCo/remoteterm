    ...
    return (
        <div className="flex flex-col items-start w-full mb-2 unselectable">
            <div className="text-secondary leading-relaxed mb-4">
                <p className="mb-0">
                    RemoteTerm v0.14.2 introduces a new block badge system for at-a-glance status, along with directory
                    ...
                    <div className="text-secondary leading-5">
                        <ul className="list-disc list-outside space-y-1 pl-5">
                            ...
                            <li>
                                ...
                                <button
                                    onClick={() => waveEnv.electron.openExternal("https://docs.rterm.dev/claude-code")}
