...
import remoteTermLogo from "/logos/remoteterm-logo.png";
...
export const ViewLogoCommand = ({ onComplete }: { onComplete?: () => void }) => {
    return (
        <FakeCommand command="wsh view public/remoteterm-logo.png" onComplete={onComplete}>
            <FakeBlock icon="image" name="remoteterm-logo.png" imgsrc={remoteTermLogo} />
        </FakeCommand>
    );
};
