    ...
    return (
        <div className="flex flex-col items-start gap-6 w-full mb-4 unselectable">
            <div className="text-secondary leading-relaxed">
                <p className="mb-0">
                    RemoteTerm v0.14.5 introduces a new Process Viewer widget, several quality-of-life improvements, and a
                    ...
                    <div className="text-secondary leading-5">
                        <ul className="list-disc list-outside space-y-1 pl-5">
                            <li>
                                ...
                                <code>app:globalhotkey</code>) now toggles a RemoteTerm window visible and invisible
                            </li>
                            <li>
