    ...
    return (
        <div className="flex flex-col items-start gap-6 w-full mb-4 unselectable">
            <div className="text-secondary leading-relaxed">
                <p className="mb-0">
                    RemoteTerm v0.13.1 focuses on Windows platform improvements, RemoteTerm AI visual updates, and enhanced
                    terminal navigation.
                </p>
            </div>
                ...
                <div className="flex flex-col items-start gap-2 flex-1">
                    ...
                    <div className="text-secondary leading-5">
                        <ul className="list-disc list-outside space-y-1 pl-5">
                            ...
                            <li>
                                <strong>Updated Focus Keybinding</strong> - RemoteTerm AI focus key changed to Alt:0 on
                                Windows
                            </li>
                        </ul>
                    </div>
            ...
            <div className="flex w-full items-start gap-4">
                ...
                <div className="flex flex-col items-start gap-2 flex-1">
                    <div className="text-foreground text-base font-semibold leading-[18px]">RemoteTerm AI Updates</div>
                    <div className="text-secondary leading-5">
                        <ul className="list-disc list-outside space-y-1 pl-5">
                            <li>
                            ...
                            <li>
                                <strong>BYOK Without Telemetry</strong> - RemoteTerm AI now works with bring-your-own-key and
