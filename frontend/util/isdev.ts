...
export const RemoteTermDevVarName = "REMOTETERM_DEV";
export const RemoteTermDevViteVarName = "REMOTETERM_DEV_VITE";
 ...
 */
export const isDev = lazy(() => !!getEnv(RemoteTermDevVarName));
 ...
 */
export const isDevVite = lazy(() => !!getEnv(RemoteTermDevViteVarName));
