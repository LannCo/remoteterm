...
RemoteTerm은 macOS, Linux, Windows에서 동작하는 오픈소스 AI 통합 터미널입니다. 어떤 AI 모델과도 함께 사용할 수 있습니다. OpenAI, Claude, Gemini는 API 키를 직접 연결해 사용할 수 있고, Ollama 및 LM Studio를 통해 로컬 모델도 실행할 수 있습니다. 계정 생성은 필요하지 않습니다.
...
- RemoteTerm AI - 터미널 출력과 위젯을 이해하고 파일 작업까지 수행할 수 있는 컨텍스트 인지형 터미널 어시스턴트
...
RemoteTerm AI는 워크스페이스 맥락을 이해하는 터미널 어시스턴트입니다.
...
자세한 내용은 [RemoteTerm AI 문서](https://docs.waveterm.dev/waveai)와 [RemoteTerm AI Modes 문서](https://docs.waveterm.dev/waveai-modes)를 참고하세요.
